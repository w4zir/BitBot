...
def chat_completion(
    *,
    ...
    if p == "ollama":
        return _ollama_chat(model, messages, timeout_seconds)
    if p == "cerebras":
        return _cerebras_chat(model, messages, timeout_seconds)
...
def _ollama_chat(model: str, messages: list[dict[str, str]], timeout_seconds: float | None) -> str:
...
def _cerebras_chat(model: str, messages: list[dict[str, str]], timeout_seconds: float | None) -> str:
